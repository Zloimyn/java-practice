package T19_FunctionalStyle_andMore.Task4;
...
public class ArithmeticOperationExample {
    ...
    private static BiFunction<Integer, Integer, Integer> getOperation(String sign) {
        switch (sign) {
            ...
            case "-": return (value1, value2) -> value1 - value2;
            case "*": return (value1, value2) -> value1 * value2;
            case "/": return (value1, value2) -> value1 / value2; //вставьте код здесь
            case "min": return (value1,value2) -> Math.min(value2, value1);
