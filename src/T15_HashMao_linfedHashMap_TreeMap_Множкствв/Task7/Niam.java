package T15_HashMao_linfedHashMap_TreeMap_Множкствв.Task7;
...
public class Niam {
    public static void main(String[] args) {
        ...
        LinkedHashMap<String,Integer> films = new LinkedHashMap<>();

        for (String actors : actorsList) {
            films.put(actors, films.getOrDefault(actors, 0) + 1);
        }
        // заполните хэш-таблицу

        for (Map.Entry<String,Integer> film : films.entrySet()) {
            String actor = film.getKey();
            int filmsCount = film.getValue();
