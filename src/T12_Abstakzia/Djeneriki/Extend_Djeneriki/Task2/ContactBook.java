...
public class ContactBook<manera extends Contact> {
        // Объявите поле класса contacts - список контактов книги
    List<manera> contacts = new ArrayList<>();

public void addContact(manera contact) {
    contacts.add(contact);
}

public void printList() {
    // Выведите на экран весь список контактов книги
    for (manera contact : contacts) {
